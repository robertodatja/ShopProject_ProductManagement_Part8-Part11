...
namespace Part9.CommandInterceptors
{
    public class SaveCommandInterceptor : ICommandInterceptor
    {
        ...
        1.Klikojme mbi Part9 pastaj mbi Dependencies-me te djathten. Pastaj Manage Nudget Packages
        ...
        Tani po te shkojme tek Part9-Dependencies-Packages do te shohim Newtonsoft.Json
        */
